...
@section('deskripsi', 'Tanda terima resmi pengajuan pelayanan masyarakat.')
...
<article class="mx-auto max-w-4xl overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-sm">
    <div class="h-1.5 bg-gradient-to-r from-orange-500 via-red-500 to-fuchsia-500"></div>

    <div class="border-b border-zinc-200 px-6 py-7 sm:px-8">
        <div class="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="rounded-xl bg-zinc-950 px-5 py-4 text-white">
    ...
    <div class="grid border-b border-zinc-200 sm:grid-cols-3">
        <div class="border-b border-zinc-200 px-6 py-5 sm:border-b-0 sm:border-r">
            <p class="text-[10px] font-semibold uppercase tracking-wider text-zinc-400">
                Status
            </p>
        ...
        <section>
            ...
            <div class="mt-4 grid gap-x-8 gap-y-5 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <p class="mt-1 break-all text-sm text-zinc-800">
                        {{ $pengguna->email }}
                    </p>
                </div>
    ...
    <div class="border-t border-zinc-200 bg-zinc-50 px-6 py-5 text-center">
