...
<head>
    ...
    <meta name="description" content="@yield('deskripsi', 'Portal Pelayanan Masyarakat Kecamatan Panakkukang')">
...
<body class="min-h-screen bg-zinc-50 text-zinc-900 antialiased">
    {{-- Garis gradasi atas --}}
    <div class="fixed inset-x-0 top-0 z-[60] h-1.5 bg-gradient-to-r from-orange-500 via-red-500 to-fuchsia-500"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (
                ...
                window.Swal.fire({
                    ...
                    confirmButtonText: notifikasi.confirmButtonText ??
                        'Mengerti',
                    confirmButtonColor: '#18181b',
                });
            }
