...
<x-pengunjung.page-hero
    kicker="Tentang Kecamatan"
    title="Profil Kecamatan Panakkukang"
...
<section class="public-section">
    <div class="public-container">
        ...
        <div class="public-service-grid">
            @foreach([
                ['Pemerintahan', 'Melaksanakan koordinasi penyelenggaraan pemerintahan di wilayah kecamatan.'],
                ['Administrasi', 'Memberikan pelayanan administrasi sesuai kewenangan dan kebutuhan masyarakat.'],
                ['Kemasyarakatan', 'Mendukung pemberdayaan, pembinaan, dan aktivitas sosial masyarakat.'],
            ] as $item)
